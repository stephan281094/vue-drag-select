(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DragSelect"] = factory();
	else
		root["DragSelect"] = factory();
...
Component.options.__file = "src/DragSelect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-db152fee", Component.options)
  } else {
    hotAPI.reload("data-v-db152fee", Component.options)
' + '  }
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "vue-drag-select", on: { mousedown: _vm.onMouseDown } },
    [
      _vm._t("default", null, { selectedItems: _vm.selectedItems }),
      _vm._v(" "),
      _vm.mouseDown
        ? _c("div", {
            staticClass: "vue-drag-select-box",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-db152fee", esExports)
  }
}
